...
class HomeScreen(QMainWindow):
    def __init__(self):
        ...
        # Styling buttons for different sections
        ...
        self.btn_add.setStyleSheet("width:200px;height:160px;font-size:20px;background:#33261D;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_manage.setStyleSheet("width:200px;height:160px;font-size:20px;background:#33261D;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_history.setStyleSheet("width:200px;height:160px;font-size:20px;background:#33261D;color:#fff;font-weight:bold;border:1px solid white")
    ...
    def showHistory(self):
        self.btn_home.setStyleSheet("width:200px;height:160px;font-size:20px;background:#33261D;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_add.setStyleSheet("width:200px;height:160px;font-size:20px;background:#33261D;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_manage.setStyleSheet("width:200px;height:160px;font-size:20px;background:#33261D;color:#fff;font-weight:bold;border:1px solid white")
    ...
    def addHomePageData(self):
        ...
        button.setStyleSheet("color:#fff;padding:8px 0px;font-size:20px;background:#008B8B;border:1px solid white")
